...
<?php
	...
	$sql = "select * from board where subject LIKE '%$search%' order by thread desc";
...
?>
        ...
        <button onclick="location.href='board_list_search.php'" style="width: 60px;height:32px">검색</button>
			<ul class="buttons">
