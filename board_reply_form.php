...
<?php
   ...
   $query = "select * from board where id='$num'";//부모글을 가져옴.
   ...
   // $parent_title_space = "";
   // $parent_title_space_add = "  ";
   //
   // for ($i = 0; $i <= $depth; $i++) {
   //   $parent_title_space = $parent_title_space.$parent_title_space_add;
   // }
   //
   // $parent_title =  $parent_title_space . "└> " . $parent_row[$subject];//RE : 를 앞에 붙여줌
...
?>
       <form  name="board_form" method="post" action="board_reply.php?num=<?=$num?>&page=<?=$page?>" enctype="multipart/form-data">
    ...
    var oEditors = [];
    var content = '원문 내용 : <br /><div align="" style=""><p><br></p><blockquote class="se2_quote3" style="_zoom:1;margin:0 0 30px 0;padding:10px;border:1px dashed #cccccc;color:#888888;"><p style="text-align: left;" align="left"><?php echo $content ?></p><p style="text-align: left;" align="left">&nbsp;</p></blockquote></div><br /> 답변 내용 :';
    ...
    //     });
          ...
          <ul class="buttons">
            <li><input type="submit" onclick="submitContents(this)" value="전송" style="width: 50px; height:32px"/></li>
